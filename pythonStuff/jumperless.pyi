...
def path_resistance(idx: int) -> Optional[float]:
    """Estimated crossbar resistance of one routed path in ohms (None if idx invalid)"""
    ...

def resistance_between(node1: NodeRef, node2: NodeRef) -> Optional[float]:
    """Parallel resistance of all stacked lanes between two nodes (None if unrouted)"""
    ...
