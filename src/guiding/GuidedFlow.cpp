...
#include "PartsApp.h"          // partsProbeButton (the sanctioned swap reader)
...
// Probe-button reading moved to partsProbeButton() (PartsApp.cpp) - the
// sanctioned revision-swapped reader that outlives this runner (A-M3).
static int guideProbeButton(void) {
    return partsProbeButton();
}
