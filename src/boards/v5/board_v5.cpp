...
// The X panel's pin table (moved from SingleCharCommands.cpp; same strings).
static const char *const kV5GpioNames[48] = {
    "UART_Tx",
    "UART_Rx",
    "LED_PROBE",
    "LED_TOP",
...
const BoardTopology v5BoardTopology = {
    ...
    kV5GpioNames, (uint8_t)(sizeof(kV5GpioNames) / sizeof(kV5GpioNames[0])),
    26, 27, RP_GPIO_26, RP_GPIO_27, "GPIO 7/8",
    {
