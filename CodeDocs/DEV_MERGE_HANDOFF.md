...
**Scheduler / hardware offload (2026-08-16/17, rows 24–29 and 32, plus the paste fix in row 30 and
...
is touched** (ProbePads 36.8 ms per call at 20 Hz), the doc had estimated ~⅓. The doc's
"▶ CONTINUE HERE" block has the queue after it (T1.5 → T1.7 → T1.6 → T1.10 → T2.2 → T2.3 →
