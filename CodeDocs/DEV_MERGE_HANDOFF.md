...
**Scheduler / hardware offload (2026-08-16/17, rows 24–29 and 32–34, plus the paste fix in row 30 and
...
CR/LF-terminated command answers ~100 ms sooner. The doc's "▶ CONTINUE HERE" block has the
queue after it (T1.6 → T1.10 → T2.2 → T2.3 → T2.1) with the design refinements found on the way.
